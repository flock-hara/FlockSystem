...
{
    public partial class frmMstOffice : Form
    {
        ...
        private void frmMstOffice_Load(object sender, EventArgs e)
        {
        ...
        private void DisplayOffice()
        {
            try
            {
                using (ClsSqlDb clsSqlDb = new(ClsDbConfig.SQLServerNo))
                {
                    ...
                    sb.AppendLine(",Mst_所属.sort");
                    sb.AppendLine(" FROM Mst_所属");

...
{
    public class clsExcelCon : IDisposable
    {
        public void Dispose()
        {
            // this.Dispose(); 
        ...
        public Boolean  OpenBook()
        {
            ...
            {
                // ファイル名、シート名指定
                Xwb = new XLWorkbook(FileName);
                Xst = Xwb.Worksheet(SheetName);
        ...
        public Boolean  DeleteWorkSheet()
        {
            ...
            Xwb.Worksheets.Delete(SheetName);
        ...
        public Boolean MoveWorkSheet()
        {
            ...
            // WotkSheet移動
            Xwb.Worksheet(SheetName).Position = this.Position;
        ...
        public Boolean SetActiveWorkSheet()
        {
            ...
            // 現在ActiveなSheet取得
            var sheet =  Xwb.Worksheets.First(_ => _.TabActive).Worksheet;
            
            // 指定Sheetと現在ActiveなSheetを比較
            if (sheet != Xwb.Worksheet(SheetName) )
            {
                // 指定SheetをActiveに設定
                Xwb.Worksheet(SheetName).SetTabActive();
...
　          // wb.Worksheet("sheet1").Cell(lastRowNumber + 1, 1).Value = "次のデータ";
        ...
        {
            // 最終列取得
            var lastcol = Xst.LastColumnUsed();
        ...
        public Boolean CopyRow()
        {
            ...
            // 各行を取得
            var row1 = Xst.Row(Row);
            var row2 = Xst.Row(Num);
        ...
        public Boolean InsertUnderRow()
        {
            ...
            // Row行目の下にNum行追加
            Xst.Row(this.Row).InsertRowsBelow(this.Num); 
        ...
        public Boolean InsertUpperRow()
        {
            ...
            // Row行目の上にNum行追加
            Xst.Row(this.Row).InsertRowsAbove(this.Num);
        ...
        public Boolean AddBeforeCol()
        {
            ...
            // Cal列目の前にNum列追加
            Xst.Column(this.Col).InsertColumnsBefore(this.Num);
        ...
        public Boolean AddAfterCol()
        {
            ...
            // Cal列目の前にNum列追加
            Xst.Column(this.Col).InsertColumnsAfter(this.Num);
        ...
        public Boolean CopyCol()
        {
            ...
            // 各列取得
            var col1 = Xst.Column(Col);
            var col2 = Xst.Column(Num);
        ...
        public Boolean WinLock()
        {
            ...
            // Row行/Col列で固定
            Xst.SheetView.FreezeRows(Row);
            Xst.SheetView.FreezeColumns(Col);
        ...
        {
            // Row行/Col列で固定解除
            Xst.SheetView.FreezeRows(0);
            Xst.SheetView.FreezeColumns(0);
        }
        #endregion
        ...
        public Boolean SetStrValueR1C1()
        {
            ...
            // セルに書込み
            Xst.Cell(Row, Col).Value = this.StrValue;
        ...
        public Boolean SetStrValueA1()
        {
            ...
            // セルに書込み
            Xst.Cell(this.Cell).Value = this.StrValue;  
        ...
        public Boolean MultiSetStrValueR1C1()
        {
            ...
            Xst.Range(Rc[0], Rc[1], Rc[2], Rc[3]).Value = this.StrValue;
        ...
        public Boolean GetCellText()
        {
            ...
            var cell = Xst.Cell(Row, Col);
            var cellText = cell.GetValue<string>();

            this.StrValue = cellText;
        ...
        public Boolean GetStrValueA1()
        {
            ...
            // セル値取得
            this.StrValue = Xst.Cell(Cell).Value.ToString();
        ...
        public Boolean  DrawColorR1C1()
        {
            ...
            //   XLColor.xxxxxx
            //
            Xst.Cell(this.Row, this.Col).Style.Fill.BackgroundColor = this.Xcolor;
        ...
        public Boolean DrawColorA1()
        {
            ...
            //   XLColor.xxxxxx
            //
            Xst.Cell(this.Cell).Style.Fill.BackgroundColor = this.Xcolor;
        ...
        public Boolean MultiDrawColor()
        {
            ...
            //   XLColor.xxxxxx
            //
            Xst.Range(Rc[0], Rc[1], Rc[2], Rc[3]).Style .Fill.BackgroundColor = this.Xcolor;
        ...
        public Boolean GetCellBackColor()
        {
            ...
            // Backcolor
            // this.Xcolor = cell.Style.Fill.BackgroundColor;
            var color = cell.Style.Fill.BackgroundColor;

            return true;
        }
        public Boolean GetCellbackColorRGB()
        {
            if (Row < 1 || Col < 1)
            {
                return false;
            ...
            // Backcolor
            this.XcolorR = cell.Style.Fill.BackgroundColor.Color.R;
            this.XcolorG = cell.Style.Fill.BackgroundColor.Color.G;
            this.XcolorB = cell.Style.Fill.BackgroundColor.Color.B;
        ...
        public Boolean  DrawUpLineR1C1()
        {
            ...
            Xst.Cell(this.Row, this.Col).Style.Border.TopBorder = this.XborderStyle;
            Xst.Cell(this.Row, this.Col).Style.Border.TopBorderColor = this.Xcolor;
        ...
        public Boolean DrawBottonLineR1C1()
        {
            ...
            Xst.Cell(this.Row, this.Col).Style.Border.BottomBorder=this.XborderStyle;    
            Xst.Cell(this.Row, this.Col).Style.Border.BottomBorderColor  = this.Xcolor;
        ...
        public Boolean DrawLeftLineR1C1()
        {
            ...
            Xst.Cell(this.Row, this.Col).Style.Border.LeftBorder = this.XborderStyle;
            Xst.Cell(this.Row, this.Col).Style.Border.LeftBorderColor = this.Xcolor;
        ...
        public Boolean DrawRightLineR1C1()
        {
            ...
            Xst.Cell(this.Row, this.Col).Style.Border.RightBorder = this.XborderStyle;
            Xst.Cell(this.Row, this.Col).Style.Border.RightBorderColor = this.Xcolor;
        ...
        public Boolean DrawRectLineR1C1()
        {
            ...
            // セルを枠線で囲む
            Xst.Cell(this.Row,this.Col).Style.Border .SetOutsideBorder(this.XborderStyle);
            Xst.Cell(this.Row, this.Col).Style.Border.SetOutsideBorderColor(this.Xcolor);
        ...
        {
            Xst.Cell(this.Row, this.Col).Style.Alignment.Horizontal = this.XalignHori;
            Xst.Cell(this.Row, this.Col).Style.Alignment.Vertical = this.XalignVart;  
        }
        #endregion
        ...
        public Boolean MargeCell()
        {
            ...
            // 範囲指定したセルを結合
            Xst.Range(Rc[0], Rc[1], Rc[2], Rc[3]).Merge();
        ...
        public Boolean UnMargeCell()
        {
            ...
            // 範囲指定したセルの結合解除
            Xst.Range(Rc[0], Rc[1], Rc[2], Rc[3]).Unmerge(); 
        ...
        public Boolean SetFontType()
        {
            ...
            Xst.Cell(this.Row, this.Col).Style.Font.FontName = this.fontName;
        ...
        public Boolean SetFontColor()
        {
            ...
            Xst.Cell(this.Row, this.Col).Style.Font.FontColor = this.Xcolor;
        ...
        public Boolean  MultiSetFontColor()
        {
            ...
            Xst.Range(Rc[0], Rc[1], Rc[2], Rc[3]).Style.Font.FontColor = this.Xcolor;
        ...
        public Boolean SetFontSize()
        {
            ...
            Xst.Cell(this.Row, this.Col).Style.Font.FontSize = this.XfontSize;
        ...
        public Boolean MultiSetFontSize()
        {
            ...
            Xst.Range(Rc[0], Rc[1], Rc[2], Rc[3]).Style.Font.FontSize = this.XfontSize;
        ...
        public Boolean SetFontBold()
        {
            ...
            Xst.Cell(this.Row, this.Col).Style.Font.Bold  = this.XfontBold;
        ...
        public Boolean MultiSetFontBold()
        {
            ...
            Xst.Range(Rc[0], Rc[1], Rc[2], Rc[3]).Style.Font.Bold = this.XfontBold;
        ...
        public Boolean SetFontItalic()
        {
            ...
            Xst.Cell(this.Row, this.Col).Style.Font.Italic = this.italic;
        ...
        public Boolean GetFontSize()
        {
            ...
            // Font名
            this.XfontSize = cell.Style.Font.FontSize;
        ...
        public Boolean GetFontBold()
        {
            ...
            // Font太字
            this.XfontBold = cell.Style.Font.Bold;
        ...
        public Boolean GetFontColor()
        {
            ...
            // Fontカラー
            this.Xcolor = cell.Style.Font.FontColor;
        ...
        #region "勤務表（エクセル）操作専用処理"
        /// <summary>
        /// セル属性の設定   ※勤務表（エクセル）操作専用
        /// </summary>
        public void sc_SetFont()
        {
        ...
        /// <summary>
        /// セルの背景色セット   ※勤務表（エクセル）操作専用
        /// </summary>
        public void sc_SetBackColor()
        {
            // 指定バックカラーを判定し、カラーコードをセット
            switch (sc_BackColor)
            {
                case "":
                    this.Xcolor = XLColor.NoColor;
                    break;
                case "Yellow":
                    this.Xcolor = XLColor.Yellow;
                    break;
                case "Orange":
                    this.Xcolor = XLColor.Orange;
                    break;
                case "SystemColor":
                    this.Xcolor = XLColor.FromArgb(16777215);
                    break;
                case "SaturDayColor":
                    //this.Xcolor = XLColor.FromArgb(14998742);
                    //this.Xcolor = XLColor.FromArgb(16775408);
                    this.Xcolor = XLColor.FromArgb(16247773);
                    break;
                case "SunDayColor":
                    this.Xcolor = XLColor.FromArgb(16751103);
                    break;
                case "HoliDayColor":
                    this.Xcolor = XLColor.FromArgb(16764159);
                    break;
                default:
                    // this.Xcolor = XLColor.NoColor;
                    this.Xcolor = XLColor.White;
                    break;
            }

            if (this.Xcolor != XLColor.NoColor) { DrawColorR1C1(); }
        }
        /// <summary>
        /// フォントカラーセット   ※勤務表（エクセル）操作専用
        /// </summary>
        public void sc_SetFontColor()
        {
            switch(sc_FontColor)
            {
                case "Black":
                    this.Xcolor = XLColor.Black;
                    break;
                case "Red":
                    this.Xcolor = XLColor.Red;
                    break;
                case "Blue":
                    this.Xcolor = XLColor.Blue;
                    break;
                default:
                    this.Xcolor = XLColor.Black;
                    break;
        ...
        /// <summary>
        /// フォント太字セット   ※勤務表（エクセル）操作専用
        /// </summary>
        public void sc_SetFontBold()
        {
            if (sc_FontBold == "太字") { this.XfontBold = true; }
            else { this.XfontBold = false; }

            SetFontBold();
        }
        /// <summary>
        /// フォントサイズセット   ※勤務表（エクセル）操作専用
        /// </summary>
        public void sc_SetFontSize()
        {
            this.XfontSize = (double)sc_FontSize;
        ...
        // ================================================================
        // 勤務表更新時のみに使用↓
        public string sc_BackColor {  get; set; }
        public string sc_FontColor { get; set; }
        public string sc_FontBold {  get; set; }
        public int sc_FontSize {  get; set; }
        // 勤務表更新時のみに使用↑
        // ================================================================
        ...
        /// WorkBook
        /// </summary>
        public XLWorkbook Xwb { get; set; }
        /// <summary>
        /// WorkSheet
        /// </summary>
        public IXLWorksheet Xst { get; set; }
        /// <summary>
        /// WorkSheetポジション
        /// </summary>
        ...
        /// カラー
        /// </summary>
        public XLColor Xcolor { get; set; }
        /// <summary>
        /// カラー（RGB）
        /// </summary>
        public int XcolorR { get; set; }
        public int XcolorG { get; set; }
        public int XcolorB { get; set; }
        /// <summary>
        /// 枠線
        /// </summary>
        public XLBorderStyleValues XborderStyle { get; set; }
        /// <summary>
        /// 文字位置（平行）
        /// </summary>
        public XLAlignmentHorizontalValues XalignHori { get; set; }
        /// <summary>
        /// 文字位置（垂直）
        /// </summary>
        public XLAlignmentVerticalValues XalignVart { get; set; }
        /// <summary>
        /// フォントサイズ
        /// </summary>
        public double XfontSize { get; set; }
        /// <summary>
        /// フォント太字
        /// </summary>
        public Boolean XfontBold { get; set; }
        /// <summary>
        /// フォントタイプ （フォント名）
        /// </summary>
